        ...
        <div className="max-w-screen-lg px-4 mx-auto my-10 md:flex md:items-center md:justify-between">
            <div className="flex justify-center md:order-2">
                ...
                <a
                    ...
                    className="ml-6 text-gray-500 hover:text-gray-400"
                >
                ...
                <a href="/rss.xml" className="ml-6 text-gray-500 hover:text-yellow-400">
            ...
            <div className="mt-8 md:mt-0 md:order-1">
                <p className="text-base leading-6 text-center text-gray-500">
                    &copy; {new Date().getFullYear()} Vic Vijayakumar
                </p>
            </div>
        </div>
    )

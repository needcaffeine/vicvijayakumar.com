...
const Head = ({ description, title, url }) => {
    ...
    return (
        <NextHead>
            ...
            <meta
                property="og:image"
                content={`${process.env.NEXT_PUBLIC_BASE_URL}/static/img/share.jpg`}
            />
            ...
            <meta name="twitter:creator" content="@vicvijayakumar" />
            <meta name="twitter:site" content="@vicvijayakumar" />

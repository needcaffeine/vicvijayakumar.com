---
title: The most interesting bug I've ever encountered
description: This is the dramatic retelling of the time I had to chase a particular bug across several layers of the stack. Read on and see if you can figure out what the issue was before I reveal it to you.
createdAt: '2021-03-30T12:00:00-04:00'
updatedAt: '2021-03-30T12:00:00-04:00'
---

This is the dramatic retelling of the time I had to chase a particular bug across several layers of the stack. It's also an exercise in writing — this post is scheduled to auto-publish at a particular time and I need to write as much as possible by then.

----

My favorite bugs to read about are the kind that make you question your sanity and then when they're fixed them you look back and are amazed at how lucky it was that you ever figured it out.
